...
namespace AgenziaConsulenzaAMM.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IRepositoryEmployee, EFRepositoryEmployee>();
            services.AddScoped<IRepositoryProgetto, EFRepositoryProgetti>();
            ...
            //{
            //    c.SwaggerDoc("v1", new OpenApiInfo { Title = "AgenziaConsulenzaAMM.API", Version = "v1" });
            //});
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "AgenziaConsulenzaAMM.API v1"));
            }
